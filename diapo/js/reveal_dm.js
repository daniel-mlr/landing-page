...
(function (root, factory) {
  ...
  var HOME_SLIDE_SELECTOR = '.slides>section:first-of-type'
  ...
  var overviewSlideWidth = null
  var overviewSlideHeight = null
  ...
  var hasNavigatedRight = false
  var hasNavigatedDown = false
  ...
  var slidesTransform = { layout: '', overview: '' }
  ...
  var autoSlidePlayer
  var autoSlideTimeout = 0
  var autoSlideStartTime = -1
    ...
    toArray(dom.wrapper.querySelectorAll(SLIDES_SELECTOR)).forEach(function (slide) {
      ...
      if (slide.classList.contains('stack') === false) {
        ...
        if (config.slideNumber && /all|print/i.test(config.showSlideNumber)) {
          ...
          var slideNumberV = parseInt(slide.getAttribute('data-index-v'), 10) + 1
  ...
  function syncBackground (slide) {
    ...
    var contentElement = slide.slideBackgroundContentElement
      ...
      if (!config.disableLayout) {
        ...
        if (scale === 1) {
          ...
          if (scale > 1 && features.zoom) {
            ...
            dom.slides.style.right = ''
            transformSlides({ layout: '' })
          } else { // Apply scale transform as a fallback
            dom.slides.style.zoom = ''
